const styles = {
   ...
   //section:'w-full px-4 lg:w-11/12 lg:mx-auto',
    ...
    button: 'w-[180px] bg-blue-600 hover:bg-blue-700 text-white h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
