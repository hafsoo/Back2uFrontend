...
import IncomingClaims from "./IncomingClaims";
        ...
        <>
          <div className="flex justify-center w-full">
            <div className="relative">
              <img
               src={avatar || user?.avatar?.url} // ✅ local preview pehle, warna server wali
               // src={`${user?.avatar?.url}`}
      ...
      {open && (
        <div className="fixed inset-0 bg-[#0000004b] flex items-center justify-center px-2">
          <div className="w-[95%] sm:w-[80%] lg:w-[35%] h-[90vh] bg-white rounded shadow relative overflow-y-auto">
            ...
            <h1 className="text-center text-[22px] sm:text-[25px] font-Poppins">
              Add New Address
            </h1>
            <div className="w-full">
                ...
                <div className="w-full block p-4">
                  <div className="w-full pb-2">
                    ...
                    <select
                      ...
                      className="w-full sm:w-[95%] border h-[40px] rounded-[5px]"
                    >
                  ...
                  <div className=" w-full pb-2">
                    <input
                      type="submit"
                      className={`${styles.input} mt-5 cursor-pointer w-full`}
                      required
                      readOnly
                    />
                  </div>
        ...
        user.addresses.map((item, index) => (
          ...
          >
            ...
            <div className="pl-8 flex items-center">
              <h6 className="text-[12px] sm:text-[14px] break-words">
                {item.address1} {item.address2}
              </h6>
            </div>
            <div className="pl-8 flex items-center">
            ...
            <div className="flex items-center justify-end sm:pl-8">
              <AiOutlineDelete
                size={25}
                className="cursor-pointer"
                onClick={() => handleDelete(item)}
